...
class CreditMemoSaveAfter implements ObserverInterface
{
    ...
    {   
        ...
        $giftCardCollection = $this->codeFactory->create()->getCollection()
            ...
            ->addFieldToFilter('status', \Magedelight\Giftcard\Model\Code::STATUS_SOLD);
        
        if($giftCardCollection->count() == 0)
            return;

        foreach($giftCardCollection as $giftCard){
            $giftCard->setStatus(\Magedelight\Giftcard\Model\Code::STATUS_INACTIVE);
            $giftCard->getResource()->save($giftCard);
            
            $comments = 'CreditMemo Generated By Admin';
